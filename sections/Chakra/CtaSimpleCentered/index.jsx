...
const App = ({ data }) => (
  <Box bg={mode('gray.200', 'gray.700')} as="section">
    ...
    >
      {data.title &&
        <Heading textTransform="uppercase" color={mode('gray.900', 'gray.200')} as="h2" size="3xl" fontWeight="extrabold" letterSpacing="tight" dangerouslySetInnerHTML={{ __html: data.title }}>
